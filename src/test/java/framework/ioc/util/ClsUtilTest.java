...
public class ClsUtilTest {
    ...
    void t5() {
        Parameter[] parameters = ClsUtil.getParameters("com.framework.ioc.util.sample.TestCar", new Class[]{String.class, int.class});
    ...
    void t8() {
        String[] parameterNames = ClsUtil.getParameterNames("com.framework.ioc.util.sample.TestCar", new Object[]{"BMW", 1234});
    ...
    void t9() {
        String[] parameterNames = ClsUtil.getParameterNames("com.framework.ioc.util.sample.TestCar", new Class[]{String.class, int.class});
